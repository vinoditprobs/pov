...
@Component({
  selector: 'app-walking-is-a-sport',
  templateUrl: './walking-is-a-sport.component.html',
  styleUrl: './walking-is-a-sport.component.scss'
})
export class WalkingIsASportComponent {
